...
<template>
    <div class="show" style="display: block; flex-direction: column;font-size: 0.14rem">
        <!-- 组合题 -->
        <template v-if="showDatas.groups === 1">
            <mix-show v-if="showDatas.publics === 1" :question="showDatas" :index="index" :hasDo="hasDo" :padingtop="padingtop"
                      :showAnswer="showAnswer" :showInput="showInput" @answer="answer" :type="'groups'">
            ...
            <group-show v-else :question="showDatas" :index="index" :hasDo="hasDo" :padingtop="padingtop" :showAnswer="showAnswer" :type="'groups'"
        ...
        <template v-else>
            <radio-show v-if="showDatas.basicType === 'Radio'" :question="showDatas" :index="index" :hasDo="hasDo"
                        :showAnswer="showAnswer" :showInput="showInput" @answer="answer" :padingtop="padingtop">
                <slot name="todoBox" slot="todo"></slot>
            ...
            <checkbox-show v-if="showDatas.basicType === 'Checkbox'" :question="showDatas" :index="index"
                           :hasDo="hasDo" :padingtop="padingtop" :showAnswer="showAnswer" :showInput="showInput" @answer="answer">
                <slot name="todoBox" slot="todo"></slot>
                <slot name="answerRight" slot="answerRight"></slot>
            </checkbox-show>
...
<script>
  ...
  export default {
    name: 'questionShow',
    props: ['showData', 'index', 'hasDo', 'showAnswer', 'showInput','answerDo', 'padingtop'],
    data () {
      return {
