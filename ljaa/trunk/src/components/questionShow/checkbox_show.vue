        ...
        <div class="qcFooter" v-if="showAnswer">
          <div>
            <div :span="22/24">
              ...
              <!-- 学生答案 -->
              <template v-if="$route.query.type !=='enjoy' && $route.query.type !=='wrong' && $route.query.type !=='notes' && questionData.studentAnswer !== undefined">
                <div class="qcfItem">
                  <span>学生答案：</span>
...
<script>
  ...
  export default {
     ...
     * questionItem 公共候选项
     */
    props: ['index', 'question', 'hasDo', 'showAnswer', 'showInput', 'questionItem', 'type', 'padingtop'],
    data () {
      return {
        answerVal: [],
