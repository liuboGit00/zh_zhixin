...
<template>
    <div class="questionBox">
        ...
        <div class="qContent">
            <!-- 问题标题 -->
            <div :class="questionData.title ? 'qcTitle' : ''">
                <!-- 问题显示区域 -->
            ...
            <div class="qcMain">
                <template v-for="(showData,cIndex) in questionData.childQuestionsList">
                    <radio-show v-if="showData.basicType === 'Radio'" :question="showData" :key="cIndex" :type="type"
                    ...
                    <checkbox-show v-if="showData.basicType === 'Checkbox'" :question="showData"
                                   :key="cIndex" :index="cIndex+1" :showAnswer="showAnswer" :showInput="showInput" :type="type"
                                   @answer="answer">
                        <slot :name="'answerRight'+showData.id" slot="answerRight"></slot>
                    </checkbox-show>
...
<script>
  ...
  export default {
     ...
     * hasDo 标题操作
     */
    props: ['index', 'question', 'hasDo', 'showAnswer', 'showInput', 'type', 'padingtop'],
    data () {
      return {
