    ...
    <div class="tHomework" style="height: 100%">
        ...
        <div style="background: #fff;margin-top: 0.2rem">
            ...
            <div v-if="step === 0">
                ...
                <flexbox v-if="type=='homework'">
                    <flexbox-item class="bolder" :span="3">作业名称</flexbox-item>
                    <div>
                        <x-input placeholder-align="right" placeholder="输入名称" text-align="right"
                                 style="min-width:2.5rem;height: 0.25rem;padding: 0 0.15rem 0 0;" class="needsclick"
                                 v-model="formValidate.title"></x-input>
                    </div>
                </flexbox>
                <flexbox v-else>
                ...
                <group class="timeBorder timeBorderTimer" style="margin-top: 0;border: none">
                    <datetime-range style="margin-top: 0;border-top: none" title="发布时间"
                                    ...
                                    v-model="startTime" @on-change="onChange($event,'startTime')"></datetime-range>
                </group>
                <group class="timeBorder timeBorderTimer" style="margin-top: 0;border: none">
                    <datetime-range style="margin-top: 0;border-bottom: none" title="截至时间"
                                    :start-date="conductDate(new Date(), 'yyyy-MM-dd')"
                                    end-date="2030-02-02" format="YYYY-MM-DD HH:mm"
                                    v-model="submitTime" @on-change="onChange($event,'submitTime')"></datetime-range>
                </group>
                <group class="timeBorder timeBorderTimer" style="margin-top: 0;border: none">
                    <datetime-range style="margin-top: 0;border-bottom: none" v-if="paperType !== 'homework'"
                                    ...
                                    @on-change="onChange($event,'publishAnswerTime')"></datetime-range>
                </group>
        ...
        <div v-if="step === 2" style="background: #fff">
            ...
            <flexbox v-if="paperType!=='homework'">
                <flexbox-item :span="4">答题时长</flexbox-item>
                <div>
                    <input style="width: 40%;outline:none;display: inline-block;border: none" v-model="formValidate.times" >
                    分钟
                </div>
            </flexbox>
...
//      },
      ...
      onChange (val,type) {
        var m = val[0].replace(/-/g, '/') + ' ' + val[1] + ':' + val[2]
      ...
      init () {
        ...
        this.onChange(this.startTime, 'startTime')
        this.onChange(this.submitTime, 'submitTime')
        this.onChange(this.publishAnswerTime, 'publishAnswerTime')
        Util = this.$util
