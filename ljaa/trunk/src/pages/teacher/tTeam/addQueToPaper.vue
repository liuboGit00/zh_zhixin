                    ...
                    <template v-if="questionSelectArr.length">
                        <template v-for="(item,index) in questionSelectArr">
                            <question-show :key="index" :index="index+1"
                                           ...
                                           :has-do="0.7" padingtop="8.5">
                                <template slot="todoBox">
                                    <button class="greenButton" style="width: 50px;background: #1cc03b;color: #fff;border-radius: 0.05rem;border: none;font-size: 12px;margin-top: 0.1rem;margin-right: 0.2rem;height: 0.28rem;line-height: 0.28rem"  mini  size="small" @click="add(item)"
