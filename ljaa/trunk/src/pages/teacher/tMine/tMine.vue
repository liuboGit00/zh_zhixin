...
<template>
    <div class="tMine">
        ...
        <div class="hello_tab">
            <div @click="openPersonal('personal')">
                <div class="Tabs" >个人资料</div>
                <div >
                    <x-icon type="ios-arrow-forward" size="0.3rem"></x-icon>
                </div>
            </div>
            <div @click="open('message')">
                <div class="Tabs" >消息</div>
                <div>
                    <x-icon type="ios-arrow-forward" size="0.3rem"></x-icon>
                </div>
            </div>
            <div @click="open('pSubmit','teacher')">
                <div class="Tabs" >意见反馈</div>
                <div>
                    <x-icon type="ios-arrow-forward" size="0.3rem"></x-icon>
                </div>
            </div>
