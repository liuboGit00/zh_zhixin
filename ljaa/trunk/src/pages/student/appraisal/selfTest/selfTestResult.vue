...
<template>
    <div class="selfTestResult-root">
        ...
        <div class="selfTestResult-root-questionBank">
            ...
            <scroller :height="top"  :scrollbar-x=false @on-scroll="getNext" v-if="questionData">
                <div ref="scroller">
...
<script>
  ...
  export default {
      ...
      getAllAnswerQuestion () {
        ...
        let opt = {
          ajaxSuccess: (data, res) => {
            ...
            console.log(this.questionList,'aaaaaaaaaaaaaaaaa')
            this.questionData = this.data[this.seq - 1]
            console.log(this.questionData,'uuuuuuu')
          },
    ...
    mounted () {
      this.top=-(this.$refs.scroller.offsetTop+155)+''
    },
