...
<template>
    <div class="questionBank">
        ...
        <div class="questionBankHeader" style="z-index: 100" :class="{'position':studentId}">
            <ul class="questionBank_nav">
                ...
                <li style="width: 25%">
                  ...
                  <select class="select" v-model="form.subject" @click="clickSubject" @change="setSubject"
                          placeholder="科目">
      ...
      <toast v-model="hasGrade" type="text" text="请先选择年级！"></toast>
    </div>
</template>
<script>
  /* 当前组件必要引入 */
  ...
  export default {
    ...
    data () {
      return {
        ...
        subjectList: null,
        textBookList:null,
        typesList: [{value: 100, title: '小升初'}, {value: 101, title: '初升高'}, {value: 102, title: '中考'}, {
          value: 103,
          title: '高考'
        }, {value: 104, title: '会考'}, {value: 105, title: '期中'}, {value: 106, title: '期末'}, {
          value: 107,
          title: '初高衔接'
        }, {value: 108, title: '寒暑假'}, {value: 109, title: '同步学练'}],
        data: [],
