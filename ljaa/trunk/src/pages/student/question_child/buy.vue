...
//        payInfo: null
    ...
    methods: {
      ...
      init () {
        //获取本地ip
        this.$util.getUserIP((ip) => { console.log(ip,'ipppppppppppppppp'); this.ip = ip })

        let {code, state} = this.$route.query;
        console.log(this.$util.isWeiXin(),'wwwwwwwwwwwwwwwwwww')
...
//              });
      ...
      toPay () {
        // if(this.ip){
        //   this.$util.setAjaxQuestHeader('x-forwarded-for',this.ip)
        // }
