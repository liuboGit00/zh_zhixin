    ...
    <div v-show="!wechating" style="position: fixed">
      ...
      <div class="hello_content">
        ...
        <div class="backGround" v-if="step==2">
          ...
          <!--</div>-->
          <div class="hiddenItem login" :style="{top:step==2?'3.1rem' :'2.3rem'}" @click="login">
            登录
          </div>
          <div class="hiddenItem" style="top:2.75rem;right: 0;text-align: left" v-if="currRole=='GUARDIAN'">
          <span @click="handleRregistered">注册账号</span>
          </div>
        ...
        <div v-if="step==3">
          ...
          <div class="hiddenItem codes" style="top: 2.45rem;height: 0.52rem;">
            <input class="inputItem" style="height: 0.52rem;width:1.8rem" v-model="form.code" placeholder="验证码"
                   type="text"/>
          ...
          <div class="hiddenItem toLogin" @click="toLogin"> 已有账号，去登录</div>
        </div>
      </div>
    </div>
