...
const cstcRouters = {
  ...
  children: [{
    ...
    component: resolve => {
      require.ensure([], () => {
        resolve(require(
          '../../components/cstc/assetManagement/deviceAssets_list.vue'))
      }, 'cstc');
    }
  },
    {
      //资产查询
      path: 'assetsManagementQuery',
      name: 'assetsManagementQuery',
      component: resolve => {
        require.ensure([], () => {
          resolve(require(
            '../../components/cstc/assetManagement/deviceAssets_list.vue'))
    ...
    },
    {
      ...
      component: resolve => {
        require.ensure([], () => {
          resolve(require('../../components/cstc/contract/contract_list.vue'));
        }, 'cstc');
      }
    },
    {
