...
const zxglRouters = {
  ...
  children: [{
  ...
  },
    {
      ...
      component: resolve => {
        require.ensure([], () => {
          resolve(require('../../components/teach/consultiveManagement/centerStyle/centerStyle_list.vue'))
        }, 'consultive')
      }
    },
    {
      //设备环境
      path: 'deviceEnvironmental',
      name: 'deviceEnvironmental',
      component: resolve => {
        require.ensure([], () => {
          resolve(require('../../components/teach/consultiveManagement/deviceEnvironmental/deviceEnvironmental_list.vue'))
        }, 'consultive')
      }
    }
  ]
