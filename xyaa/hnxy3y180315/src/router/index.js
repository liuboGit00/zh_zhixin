...
import exam from'../components/common/exam.vue'
// 技能中心理论考核（与管理系统无关）
...
// 对外开放
import dykf from './subRouter/dykf';
// 本科教学
import bkjx from './subRouter/bkjx';
// 培训项目
import pxxm from './subRouter/pxxm';
...
// 对外开发
import dwkf from './subRouter/dwkf'
...
// import Ecarts from '../components/physicianExam/physicianMonitor/physicianMonitorEcharts'
/*
* 404页面配置
* */
...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      component: resolve => {
        require.ensure([], () => {
          resolve(require('../components/physicianExam/physicianMonitor/physicianMonitorEcharts'));
      ...
      component: resolve => {
        require.ensure([], () => {
          resolve(require('../components/physicianExam/hkxx/waitRoomInfo'));
        }, 'physicianExamineInterval');
      }},
      { path: 'examControl',
      name: 'examControl',
      ...
      component: resolve => {
        require.ensure([], () => {
          resolve(require('../components/physicianExam/kskz/examControl'));
        }, 'physicianExamineInterval');
      }}
    ],
  },
