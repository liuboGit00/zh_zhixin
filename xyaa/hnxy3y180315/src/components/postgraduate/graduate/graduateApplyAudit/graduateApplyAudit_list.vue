    ...
    <el-form  :model="formValidate" :rules="rules" ref="formValidate" inline label-width="100px">
      ...
      <div v-show="searchMore" ref="searchMore">
        ...
        <el-form-item label="状态" prop="status" >
          <el-select  v-if="typeView=='DS'" filterable  v-model="formValidate.status" placeholder="请选择">
            <el-option label="待审核" value="DSH"></el-option>
            <el-option label="不通过" value="DSBH"></el-option>
            <el-option label="通过" value="DSTG"></el-option>
          </el-select>

          <el-select v-else-if="typeView=='KEZR'" filterable  v-model="formValidate.status" placeholder="请选择">
            ...
            <el-select v-else-if="typeView=='YJSGL'||typeView=='JYC'" filterable v-model="formValidate.status"
                       placeholder="请选择">
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template scope="scope">
              ...
              <el-button type="primary" size="small" @click="audit(scope.row)" :disabled="typeView =='DS' && scope.row.status != 'DSH' || typeView =='KEZR' && scope.row.status != 'DSTG' || typeView =='JYC' && scope.row.status != 'JYSTG'">审核</el-button>
          ...
          <el-table-column
                  v-if="typeView=='YJSGL'||typeView=='JYC'"
                  show-overflow-tooltip
                  prop="status"
                  label="状态">
            <template scope="scope">
