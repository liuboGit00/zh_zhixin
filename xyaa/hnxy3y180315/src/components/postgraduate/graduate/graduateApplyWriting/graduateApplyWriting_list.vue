    ...
    <el-form v-for="item in 1" :key="item" :model="formValidate" :rules="rules" ref="formValidate"
      ...
      <el-row>
        <el-col :span="5" :offset="2">
          <el-form-item label="离院时间:" prop="leaveDate">
            <el-date-picker
              v-if="isWrite"
              :editable="false"
        ...
        <el-col :span="8" :offset="2">
          <el-form-item label="毕业去向:" prop="whereabouts">
            ...
            <div v-else> {{formValidate.whereabouts}}</div>
          </el-form-item>
        </el-col>
        <el-col :span="8" :offset="2">
          <el-form-item label="三甲医院:" prop="isThree">
      ...
      <template v-if="auditStep(formValidate.status)>-1">
        <br>
        <!--审核-->
        <el-steps :active="activeAudit" finish-status="success">
  ...
  * */
      listenSubEvent(isLoadingFun) {
        ...
        if (isSubmit) {
          ...
          this.formValidate.graduationSublist = this.formDate(Util._.defaultsDeep([], this.tableData), ['creationdate'], 'yyyy-MM-dd');
