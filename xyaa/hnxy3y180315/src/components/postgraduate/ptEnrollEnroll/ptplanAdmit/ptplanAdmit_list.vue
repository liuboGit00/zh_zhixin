...
<template>
  <div id="content" ref="content" class="modal">
    <el-form :model="formValidate" :rules="rules" ref="formValidate" inline label-width="100px">
      <el-row style="margin-bottom:0">
        ...
        <el-col :span="13">
          ...
          <el-form-item>
            <el-button type="info" @click="openModel('derive')">导出拟录取信息到Excel</el-button>
          </el-form-item>
        </el-col>
        <!--搜索项-->
    ...
    <div>
      ...
      <div id="myTable" ref="myTable">
        <el-table align="center" :height="dynamicHt" :context="self" :data="tableData" tooltip-effect="dark"
          ...
          <el-table-column show-overflow-tooltip prop="major" label="专业名称">
          </el-table-column>
          ...
          <el-table-column show-overflow-tooltip prop="initialScore" label="初试成绩">
          </el-table-column>
    ...
    <Modal close-on-click-modal="false" height="200" v-model="deriveModal" title="对话框标题"
      ...
      <derive v-if="deriveModal" :url="url.exportQuasiadmission.path" type="derive" messTitle="导出录取信息到Excel"
