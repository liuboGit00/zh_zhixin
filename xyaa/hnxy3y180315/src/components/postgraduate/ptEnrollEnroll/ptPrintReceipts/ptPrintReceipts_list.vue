...
<template>
  <div ref="conten">
    <el-form :model="searchObj" ref="searchObj" inline>
      <el-row>
        ...
        <el-col :span="10">
          ...
          <el-button type="danger" @click="print" :disabled="disabled.print">打印收费单</el-button>
        </el-col>
        <!--搜索项-->
        <el-col :span="14" align="right">
          <el-form-item prop="name">
            <el-input style="width:300px;" v-model="searchObj.name" placeholder="输入姓名搜索">
        ...
        <el-col v-show="searchMore" ref="searchMore" align="right">
          ...
          <el-form-item label="专业：">
            <el-select v-model="searchObj.major" clearable placeholder="请选择">
              <major></major>
            </el-select>
          </el-form-item>
    ...
    <!--打印-->
    <Modal :mask-closable="false" width="1000" v-model="printModal" class-name="vertical-center-modal"
           :loading="loading">
