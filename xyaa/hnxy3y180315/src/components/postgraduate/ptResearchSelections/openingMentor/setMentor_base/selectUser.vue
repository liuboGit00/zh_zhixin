<template>
  <div>
    ...
    <layout-tree style="height: 550px">
      <left slot="left" @tree-click="treeClick" :ajaxData="ajaxData" :treeOptions="treeDefaults" :fromWhereTreeType="fromWhereTree"></left>
...
<script>
  ...
  let Util = null;
  export default {
    props: ["initUser", 'isOnlyOne', 'url', 'unSelect','ajaxData','treeOptions'],
    data() {
      return {
        //tree默认项设置
        treeDefaults: {
