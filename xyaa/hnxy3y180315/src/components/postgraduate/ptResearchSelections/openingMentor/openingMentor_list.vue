...
<template>
  <div id="content" ref="content">
    ...
    <div style="margin-bottom: 20px;">
      ...
      <el-button v-else type="primary" @click="" :disabled="true">发布</el-button>
      <el-button v-if="isDelet" type="danger" @click="remove">删除</el-button>
      <el-button v-else type="danger" @click="" :disabled="true">删除</el-button>
    </div>
    ...
    <div>
      ...
      <Modal close-on-click-modal="false" height="200" v-model="removeModal" title="对话框标题" class-name="vertical-center-modal" :loading="loading"
        ...
        <remove v-if="removeModal" :deleteUrl="api.removes" @remove="subCallback" @cancel="cancel" :operaility-data="operailityData"></remove>
        <div slot="footer"></div>
      </Modal>
      <!-- 模态框 查看（view） -->
