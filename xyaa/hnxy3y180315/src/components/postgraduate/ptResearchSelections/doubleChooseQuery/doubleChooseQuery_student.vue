<template>
  <div id="content" ref="content" style="position: relative;">
    ...
    <el-form :inline="true" :model="formInline" class="demo-form-inline">
      ...
      <!--<el-form-item label="专业">-->
        <!--<el-select v-model="formInline.major" placeholder="">-->
          <!--<el-option label="内科学" value="内科学"></el-option>-->
          <!--<el-option label="神经病学" value="神经病学"></el-option>-->
          <!--<el-option label="外科学" value="外科学"></el-option>-->
          <!--<el-option label="妇产科学" value="妇产科学"></el-option>-->
    ...
    <!--<div style="margin-bottom: 20px;">-->
      <!--<el-button :disabled="true" type="primary" @click="">安排面试</el-button>-->
    <!--</div>-->
