  ...
  <div class="arrangeTab-zyy" style="height: 700px;overflow: auto;">
    <el-tabs v-model="activeName"  @tab-click="handleClick">
      <el-tab-pane label="按专业排" name="arrangeByGroup">
        <keep-alive>
          <by-specialty v-if="showFirstLab" :userType="userType" @add="subCallback" :isInit="count" style="height: 100%;"></by-specialty>
        </keep-alive>
      </el-tab-pane>
      <el-tab-pane label="按人员排" name="arrangeByUser">
        <keep-alive>
          <by-user v-if="showSecondLab" :userType="userType" @add="subCallback" :isInit="count" style="height: 100%;"></by-user>
        </keep-alive>
      </el-tab-pane>
    </el-tabs>
  </div>
