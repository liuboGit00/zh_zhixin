  ...
  <div id="content" ref="content" class="modal">
      ...
      <el-form :inline="true" ref="formValidate" :model="formValidate">
        ...
        <el-form-item label="人员属性：" prop="rotaryZyyType">
          <el-select v-model="formValidate.rotaryZyyType" filterable placeholder="请选择">
            <selectOption type="getByCode"  isCode="true" id="value" codeType="ROTARY_ZYY_TYPE"></selectOption>
          </el-select>
        </el-form-item>

        <el-form-item label="是否职业医师：" prop="doctor">
          <el-select v-model="formValidate.doctor " filterable clearable placeholder="请选择" style="width:175px;" class="nation">
    ...
    <div>
      ...
      <Modal :mask-closable="false" v-model="depMoveModal" height="200" class-name="vertical-center-modal" :width="960">
        ...
        <dep-move v-if="depMoveModal" @cancel="cancel" @depMove="subCallback" :parentTreeDefaults="treeDefaults"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      /*--点击--删除--按钮--*/
      remove() {
        if (!this.isSelected()) return//如果没有选择 提示让用户选择
