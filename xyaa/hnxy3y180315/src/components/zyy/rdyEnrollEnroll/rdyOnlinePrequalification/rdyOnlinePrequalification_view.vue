    ...
    <table class="el-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td colspan="2"><p class="cell">{{ userInfo.englishLevel }}</p></td>
          <td><p class="cell">计算机水平</p></td>
          <td colspan="2"><p class="cell">{{ userInfo.computerLevel }}</p></td>
        </tr>
        ...
        <tr>
          <td><div class="cell single"><p>应聘人员承诺</p></div></td>
          <td colspan="3">
            <div class="cell indent">
              本人承诺所提供的材料真实有效，符合应聘岗位所需的资格条件。如有弄虚作假，承诺自动放弃考试和聘用资格。
            </div>
          </td>
          <td><div class="cell single"><p>资格审查意见</p></div></td>
          <td colspan="3 indent">
        ...
        <tr>
          <td><div class="cell single"><p>备注</p></div></td>
          <td colspan="7">
            <div class="cell indent">
              我院招聘过程中所有考务通知均通过鼓楼医院官网发布，不再以其它任何形式通知到个人，请及时留意官网通知，未及时查看通知导致应聘者错过我院招聘考试考核责任自负，认可以上通知请确认签名：
            </div>
          </td>
        </tr>
