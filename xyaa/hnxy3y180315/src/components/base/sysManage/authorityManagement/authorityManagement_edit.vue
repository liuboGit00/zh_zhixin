          ...
          <fieldset>
            ...
            <div class="funMeus">
              <el-row style="height: 100%;">
                <el-col :span="7" style="height: 100%" v-if="funMenus.length">
                  <!--<div style="height: 200px;overflow: auto">-->
                  <Menu :theme="theme1" @on-select="selectMenus" :active-name="active" style="height: 100%;width: 200px;overflow: auto;">
                    <Menu-group title="">
                      <Menu-item v-for="(item,index) in funMenus" :key="index" :name="(index+1)">
                        <el-checkbox v-model="item.checked" @change="sltAllCheckbox">&nbsp;</el-checkbox><span>{{item.name}}</span>
                      </Menu-item>
                    </Menu-group>
                  </Menu>
                  <!--</div>-->
