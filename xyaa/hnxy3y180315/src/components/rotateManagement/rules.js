...
let entityWrite = {
  ...
  mainDiagnosis: [{ required: true, message: '此项必填'},baseRules.inputLen(0,1000),baseRules.illegalChar()], // 主要诊断
  secondaryDiagnosis: [{ required: true, message: '此项必填'},baseRules.inputLen(0,1000),baseRules.illegalChar()], // 主要诊断
