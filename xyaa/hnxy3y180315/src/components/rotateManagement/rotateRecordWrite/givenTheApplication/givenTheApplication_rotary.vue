...
//            }
          ...
          ajaxParams:{
            url:api.queryOldRotaryDept.path + this.operailityData.podId,
      ...
      getDepRequirementBySXS() {
        this.ajax({
          ...
          ajaxParams: {
            ...
            //修改增加其它三个id
            url: api.getDepRequirementBySXS.path + (this.operailityData.rdId || '') + '-' + (this.operailityData.depId || '') + '-' + this.operailityData.podId,
