<template>
  <div id="content" ref="content" class="modal">
        ...
        <el-table
          ...
          <el-table-column label="操作" width="100" align="center">
            <template scope="scope">
              ...
              <el-button
                size="small"
                :disabled="['N','Y'].includes(scope.row.arrangeDepState)"
    ...
    <Modal
      ...
      <operate v-if="noRotationModal" :type="'noRotation'" :operateData="noRotationData" :operate-url="api.modifyDepRotaryState.path"  @cancel="cancel" @operate="subCallback"  ></operate>
      <div slot="footer"></div>
    </Modal>
  </div>
</template>
