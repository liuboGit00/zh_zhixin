...
<template>
  <div id="content" ref="content" class="modal">
    ...
    <Modal
      ...
      <operate v-if="passModal" :type="'pass'" :operate-url="url.skillRecordManageModifySubPass" :methods="'post'" :operateData="passData" @cancel="cancel" @operate="subCallback" :operaility-data="operailityData" ></operate>
      <div slot="footer"></div>
    </Modal>
    ...
    <Modal
      ...
      <operate v-if="rejectModal" :type="'reject'" :operate-url="url.skillRecordManageModifySubReject" :operateData="passData" :methods="'post'"  @cancel="cancel" @operate="subCallback" :operaility-data="operailityData" ></operate>
      <div slot="footer"></div>
    </Modal>
