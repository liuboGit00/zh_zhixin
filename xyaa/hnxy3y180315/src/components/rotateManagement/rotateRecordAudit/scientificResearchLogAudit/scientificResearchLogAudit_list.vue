...
<template>
  <div id="content" ref="content" class="modal">
    ...
    <Modal
      ...
      <operate v-if="passModal" :type="'pass'" :operateData="modifySubPassData" :methods="'post'"  @cancel="cancel" @operate="subCallback" :operaility-data="operailityData" ></operate>
      <div slot="footer"></div>
    </Modal>
    ...
    <Modal
      ...
      <operate v-if="rejectModal" :type="'reject'"  :operateData="modifySubRejectData" :methods="'post'"  @cancel="cancel" @operate="subCallback" :operaility-data="operailityData" ></operate>
      <div slot="footer"></div>
    </Modal>
    <!---->
  </div>
...
//          }
    ...
    methods: {
      ...
      pass(){
        ...
        this.modifySubPassData.data.ids = tempArr.join(',');
        this.openModel('pass') ;
      },
      ...
      reject(){
        ...
        this.modifySubRejectData.data.ids = tempArr.join(',');
