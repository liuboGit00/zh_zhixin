      ...
      <el-table ref="multipleTable" align="center" :height="tabHeight" :context="self" :data="tableData" tooltip-effect="dark" style="width: 100%">
        <el-table-column label="操作" align="center" :width="140">
          <template scope="scope">
            ...
            <el-button v-if="canSetTs()" :disabled="scope.row.state === 'SUBMIT'" size="small" type="info" @click="add(scope.row)">设置</el-button>
          </template>
        </el-table-column>
...
//          sortby: 'podId',
    ...
    methods: {
      ...
      canSetTs(){
        let can = false;
        let canDoUser = ['SXSGL','YJSGL','ZYYGL','JXSGL'];// 分管教育处
