...
<template>
  <div class="container" :class="defaults.cls">
    ...
    <div v-if="defaults.isShowMenus" class="treeMenus" style="">
      <el-button type="primary" @click="add" :disabled="sltParentId !== 0">新建</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      loadNode(node, resolve) {
        ...
        let getSubNode = {
          ajaxSuccess: (res) => {
            ...
            if (!node.parent) { // 如果node parent为null则打开该节点并选中
              ...
              // console.log(nodeId,res.data[0],'res.data[0]')
        ...
        // console.log(getSubNode.ajaxParams.params,'params')
      ...
      treeClick(obj, node, self) {
        // console.log(obj, node, self,'obj, node, self')
