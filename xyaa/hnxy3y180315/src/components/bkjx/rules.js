...
let classManage = {
  weekTimes:[baseRules.requiredNoEvent,baseRules.greaterThanZero],//周次
  sectionOrderStart:[baseRules.requiredNoEvent,baseRules.greaterThanZero],//节次开始
  sectionOrderEnd:[baseRules.requiredNoEvent,baseRules.greaterThanZero],//节次结束
  // classHour:[baseRules.requiredNoEvent,baseRules.numbers],//学时
  studentNum:[baseRules.requiredNoEvent,baseRules.numbers],//人数
  // userHour:[baseRules.required,baseRules.numbers],//人时
  courseDate:baseRules.requiredNoEvent,//上课日期
  // weekDay:baseRules.required,//星期
  grade:baseRules.required,//年级
  specialty:baseRules.required,//专业
  groupTeam:baseRules.required,//组别
  courseContent:baseRules.required,//课程内容
  courseName:baseRules.required,//课程名称
  courseCode:baseRules.required,//课程编号
  teacherName:baseRules.required,//教师
  jobTitle:baseRules.required,//职称
  jysName:baseRules.required,//教研室
  teachPlace:baseRules.required,//授课地点
  schoolYear:baseRules.required,//学年
  term:baseRules.required,//学期
}
/**
 * 考核内容管理 - 评分
 */
