  ...
  <div id="bespeakApply" ref="bespeakSetRoom">
    <el-row style="padding-bottom:20px;">
      ...
      <el-col :span="24">
          ...
          <el-form-item label="审核时间" prop="activityEndTime">
            ...
            :picker-options="pickerOptions1"
              ></el-date-picker>
              至
              <el-date-picker v-model="searchObj.endApprovalDate"
              @change="setYear"
              placeholder="结束时间"
            :picker-options="pickerOptions1"
              ></el-date-picker>
      ...
      >
        ...
        <el-table-column label="操作">
          <template scope="scope">
            <div>
              ...
              <el-button size="small" v-if="scope.row.status == 'GLYSP'" type="info" @click="edit(scope.row)">审核</el-button>
            </div>
          </template>
        </el-table-column>
        ...
        <el-table-column label="审核时间" prop="approvalDate" show-overflow-tooltip>
          <!--<template scope="scope">-->
          <!--{{ scope.row.applicantDate }}-->
          <!--</template>-->
        </el-table-column>
...
import show from "./appointmentAudit_show.vue"; // 查看
import edit from "./appointmentAudit_edit.vue"; // 新建审核
