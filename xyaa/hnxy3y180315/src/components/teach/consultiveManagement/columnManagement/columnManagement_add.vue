  ...
  <div>
    <el-form  :model="formValidate" ref="formValidate" :rules="columnManagement" class="demo-form-inline" label-width="110px" >
      ...
      <el-row v-if="!isRoot">
        ...
        <el-col :span="10" :offset="2">
          <el-form-item label="是否是单一资讯:">
            <el-radio-group  v-model="formValidate.isSingle">
    ...
    methods:{
      ...
      * */
      listenSubEvent(isLoadingFun){
        if(this.formValidate.isFunc=='YES'&&!this.formValidate.moduleUrl){
          this.errorMess('请输入url地址');
          return
        }
