...
<template>
  <layout-tree>
    <left-tree slot="left" @setCurrSltNodeId="setTreeId" :currentKey="formValidate.parentId" @tree-click="treeClick"
               :treeOptions="treeDefaults"></left-tree>

    <div slot="right" id="content" ref="nosocomial" class="table-content ">
      <el-form :model="formValidate" ref="formValidate" :rules="columnManagementList" inline label-width="90px"
               class="demo-ruleForm">
        <el-row>
          <el-col :span="10">
            <el-button class="but-col" @click="add" type="primary">添加子栏目</el-button>
            <el-button class="but-col" :disabled="disabled.remove" @click="remove" type="primary">删除</el-button>
      ...
      <div style="margin: 10px;">
        ...
        <Modal
          ...
          <add v-if="addModal" :isRoot="isShow" @cancel="cancel" @add="subCallback" :operaility-data="parent"
               :url="url"></add>
          <div slot="footer"></div>
        </Modal>
        <!---->
