      ...
      <el-row>
        ...
        <el-col :span="17" :offset="2" v-if="isPictureNews">
          <el-form-item label="标题图片:" prop="titlePicturePath" class="feildFontweight is-required">
            <upload-photo-wall type="picture" :onlyOnePic="true" :actionUrl="'/file/upload/static'" @upladSuccess="upladSuccess"></upload-photo-wall>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        ...
        <el-col :span="8" :offset="1">
          <el-form-item label="来源:" prop="source" class="feildFontweight">
            ...
            <el-select v-model="formValidate.source" placeholder="请选择" style="width: 100%">
              <el-option
      ...
      <el-row>
        ...
        <el-col :span="8" :offset="1">
          <el-form-item label="内容类型:" class="contentType">
            <el-select v-model="formValidate.contentType" placeholder="请选择" style="width: 100%">
              <el-option
...
//        }
      ...
      columnCallback (data) {
        ...
        this.isPictureNews = data.isPictureNews === 'YES'
        this.subCancel();
