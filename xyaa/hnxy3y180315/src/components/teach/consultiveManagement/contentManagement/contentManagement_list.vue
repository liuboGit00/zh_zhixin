...
<template>
  <layout-tree>
    ...
    <div slot="right" id="content" ref="nosocomial" class="table-content ">
      <edit v-if="isSingle" style="overflow: auto;height: 100%" :isSingle="isSingle"   @cancel="cancel"  @edit="subCallback"  :operaility-data="operailityData"  :url="url"> </edit>
      <!--右侧查询-->
      <el-form v-else  :model="formValidate" ref="formValidate" :rules="contentManagementList"   inline label-width="90px" class="demo-ruleForm">
        <el-row >
          <el-col :span="10" >
      ...
      <div v-if="!isSingle"
        ...
        <el-table
          ...
          <el-table-column
            ...
            show-overflow-tooltip>
            <!--<template scope="scope">-->
            <!--&lt;!&ndash;{{ scope.row.createTime | formatDate('yyyy-MM-dd') }}&ndash;&gt;-->
            <!--</template>-->
          </el-table-column>
          <el-table-column
            prop="publishDate"
      ...
      <div style="margin: 10px;" v-if="!isSingle">
...
//        this.setTableData();
      ...
      add(){
//        if (this.treeData.isFunc == 'YES') {
//          this.showMess('功能节点，不能进行此操作');
//          return true;
//        }
        this.openModel('add') ;
      },
...
//        this.isSingle=true;
//        this.operailityData={id:obj.id};
//        return
        if(obj.level==3&&obj.isSingle=='YES'){
           if(this.isSingle){
             this.isSingle=false
             setTimeout(()=>{
               this.isSingle=true
