                ...
                <el-col :span="24">
                  <div class="grid-content-ptop">
                    ...
                    <el-select v-show="formValidate.activityUserType=='ROTARYDEP'"
                      ...
                      <el-option v-for="(item,index) in depDta" :key="index"  :label="item.name" :value="item.id"></el-option>
                    </el-select>
                    <div v-show="formValidate.activityUserType=='ROTARYDEP'" style="display:inline-block;width: 100px;font-size:14px;text-align: right">人员类型:</div>
                      <el-select v-show="formValidate.activityUserType=='ROTARYDEP'" multiple @change="activityDepUserTypeChange" v-model="formValidate.activityDepUserType" clearable placeholder="请选择">
                  ...
                  <div class="grid-content-ptop">
                    <el-radio :label="'PARTUSER'">部分人员</el-radio>
                      <!--<el-select style="margin-left: 10px;height: 50px" @remove-tag="userRemove"  v-show="formValidate.activityUserType == 'PARTUSER'" placeholder multiple v-model="partuser.activityUserTypeValue" filterable placeholder="请选择">-->
                        ...
                        <!--</el-option>-->
                      <!--</el-select>-->
                    <div v-show="formValidate.activityUserType == 'PARTUSER'"  style="max-width: 350px;max-height: 100px;overflow: auto;display: inline-block;vertical-align: middle">
                      <el-tag
