      ...
      <template v-if="editModal">
        ...
        <!--<template v-if="userInfo.auditStatus == 'AUDIT_SUCCESS'">-->
          <template v-if="['SXS','BKS','YJS','ZYY','JXS'].indexOf(userType) > -1">
            ...
            <!--</template>-->
            <sxs-archives v-if="userType === 'SXS'" @cancel="cancel" @edit="subCallback" :auditType="auditType" :operaility-data="operailityData" :userInfo="userInfo" :mustUploadHP="true" :formWhere="formWhere"></sxs-archives>
            <zyy-archives v-if="userType === 'ZYY'" @cancel="cancel" @edit="subCallback" :auditType="auditType" :operaility-data="operailityData" :mustUploadHP="true"></zyy-archives>
            <yjs-archives v-if="userType === 'YJS'" @cancel="cancel" @edit="subCallback" :auditType="auditType" :operaility-data="operailityData" :mustUploadHP="true"></yjs-archives>
            <jxs-archives v-if="userType === 'JXS'" @cancel="cancel" @edit="subCallback" :auditType="auditType" :operaility-data="operailityData" :mustUploadHP="true"></jxs-archives>
            <bks-archives v-if="userType === 'BKS'" @cancel="cancel" @edit="subCallback" :auditType="auditType" :operaility-data="operailityData" :mustUploadHP="true"></bks-archives>
          </template>
          <archives v-else @cancel="cancel" @edit="subCallback" :auditType="auditType" :operaility-data="operailityData" :mustUploadHP="true"></archives>
        <!--</template>-->
      </template>
      <div slot="footer"></div>
    </Modal>
