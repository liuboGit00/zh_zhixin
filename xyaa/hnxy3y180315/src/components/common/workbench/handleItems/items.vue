...
<script>
  ...
  import rotaryScientificResearchModelView from '../../../educationManagement/academicConference/MeetingReportAudit/meetingReportAudit_add.vue';
    ...
    data() {
      return {
        ...
        propsData: { // 模块传值时的特殊id
          ...
          DEPEXAMINATION_PUSH_MODEL: 'depExaminationId',
...
//          ...teachingActivities,
        ...
        this.getArrs();
        this.identify = this.$store.getters['getUserInfo'].roleList[0].identify;
      },
      getArrs() {
