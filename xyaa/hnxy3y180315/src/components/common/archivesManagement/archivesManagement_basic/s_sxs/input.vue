            ...
            <el-row :gutter="10" class="table-back-one">
              <el-col :span="8">
                ...
                <el-form-item label="姓名：" prop="name">
                  ...
                  <span v-else-if="formValidate.auditStatus=='AUDIT_SUCCESS'||formValidate.auditStatus=='NOT_AUDIT'">{{formValidate.name}}</span>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      //初始化
      this.init();
      this.uploadHeaderUrl = pubApi.uploadHeaderUrl+'?userId='+this.operailityData.id;
    },
    methods: {
      /*
       * 组件初始化入口
