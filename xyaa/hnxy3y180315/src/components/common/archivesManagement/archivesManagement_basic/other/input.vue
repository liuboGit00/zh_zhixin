...
<script>
  ...
  export default {
    ...
    created() {
      ...
      //初始化
      this.init();
      console.log(this.operailityData.school!='undefined')
      if(this.operailityData.school!='undefined'){

        this.operailityData.school=this.operailityData.schoolName;
      }
      this.uploadHeaderUrl = api.uploadHeaderUrl+'?userId='+this.operailityData.id;
    },
    methods: {
      /*
       * 组件初始化入口
