...
//            that.setTableData(row, key, val)
      ...
      converter(type) {
        //产假，探亲假，丧假 是其他
        let text = {
          CQ: 'workAttendance', SJ: 'compassionateLeave', BJ: 'sickLeave', CJ: 'otherLeave', TQJ: 'otherLeave',
          SANGJ: 'otherLeave', HJ: 'marriageLeave', KG: 'absenteeism', CD: 'late', ZT: 'leaveEarly',OTHER: 'otherLeave',
        };
        return text[type] || '';
      },
