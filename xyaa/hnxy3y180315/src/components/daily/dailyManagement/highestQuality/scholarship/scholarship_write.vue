    ...
    <el-form ref="formValidate" class="demo-form-inline " label-width="100px">
      ...
      <fieldset class="layui-elem-field">
        ...
        <div class="layui-field-box">
          <el-row class="table-back-one">
            <el-col :span="7" :offset="1">
              <el-form-item label="家庭月总收入:" prop="name">
                <el-input v-model.number="formValidate.grossIncome" type="number" placeholder="请输入内容"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="7">
              <el-form-item label="人均月收入:" prop="name" class="feildFontweight">
                <el-input v-model.number="formValidate.averageIncome" type="number" placeholder="请输入内容"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="7">
          ...
          <el-row class="table-back-two">
            ...
            <el-col :span="10">
              <el-form-item label="家庭总人数:" prop="name" class="feildFontweight">
                <el-input v-model.number="formValidate.peopleNum" type="number" placeholder="请输入内容"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row class="table-back-one-d">
            ...
            <el-col :span="10">
              <el-form-item label="邮政编码:" prop="name" class="feildFontweight">
                <el-input v-model.number="formValidate.postCode" type="number" placeholder="请输入内容"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </div>
