  ...
  <div>
    <el-form :model="formValidate" ref="formValidate" :rules="rules.myLeave" class="demo-form-inline"
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="现所在科室:" prop="depId">
...
//            this.ajax(this.listMessTitle)
    ...
    methods: {//判断日期
      ...
      //初始化podId
      initPodId() {
        if (this.formValidate.podId && this.depObj) {
          this.formValidate.depId = this.formValidate.podId = this.depObj[this.formValidate.podId]
        }
      },
      // 处理科室数据结构（三级以下）
