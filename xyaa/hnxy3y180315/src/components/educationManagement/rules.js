...
let outEducationAntragInput = {
    ...
    studyFee: [baseRules.float2(0, 1000000), baseRules.inputLen(0, 20), baseRules.illegalChar()],  //进修费</
    hotelFee: [baseRules.float2(0, 1000000), baseRules.inputLen(0, 20), baseRules.illegalChar()],   //住宿费
    trafficFee: [baseRules.float2(0, 1000000), baseRules.inputLen(0, 20), baseRules.illegalChar()],   //交通费
};
