  ...
  <div class="srMain">
    <el-form :model="formValidate" ref="formValidate" :rules="rules">
      ...
      <el-form-item prop="eduExpertOpinion">
        <el-input type="textarea" :autosize="{ minRows: 4, maxRows: 6}" v-model="formValidate.eduExpertOpinion"> </el-input>
      </el-form-item>

      <h4 class="otherTitle">科室鉴定附件</h4>
      <upload-file @setUploadFiles="setUploadFiles" :uploadFiles="eduFiles"></upload-file>
