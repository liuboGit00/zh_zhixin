<template>
  ...
  <div id="content" ref="content" class="modal">
    <div class="listUpAreaBox" style="margin-bottom:20px;">
      <div class="listUpArea-menus" v-if="deptId">
    ...
    <div id="myTable" ref="myTable" class="userDataTable">
      <el-table ref="multipleTable" align="center" :height="tabHeight"
                :context="self" :data="tableData" tooltip-effect="dark"
        ...
        <el-table-column label="操作" align="center" width="200">
          <template scope="scope">
            ...
            <el-button size="small" v-if="scope.row.account.enable"
                       class="but-col"
    ...
    <div>
      ...
      <Modal :mask-closable="false" close-on-click-modal="false" height="200"
             v-model="removeModal" class-name="vertical-center-modal"
             :width="500">
        <modal-header slot="header" :content="removeId"></modal-header>
        <operate v-if="removeModal" type="remove" @operate="subCallback"
                 @cancel="cancel" :operateData="removeOperateData"></operate>
        <div slot="footer"></div>
      </Modal>
      <!--导入弹窗-->
      <Modal :mask-closable="false" close-on-click-modal="false" height="200"
             v-model="toChannelModal" class-name="vertical-center-modal"
             :width="800">
        <modal-header slot="header" :content="toChannelId"></modal-header>
        <toChannel v-if="toChannelModal" :deptId="deptId"
                   @toChannel="subCallback" @cancel="cancel"
                   :operaility-data="operailityData"></toChannel>
        <div slot="footer"></div>
      </Modal>
      <!--导出弹窗-->
      <Modal :mask-closable="false" close-on-click-modal="false" height="200"
             v-model="deriveModal" class-name="vertical-center-modal"
             :width="500">
...
//        return this.isClassNode
      ...
      remove() {
        ...
        this.removeOperateData.params = {ids}
