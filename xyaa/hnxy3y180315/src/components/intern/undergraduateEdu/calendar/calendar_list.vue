...
<template>
  <div id="content"  ref="content"  class="modal">
        ...
        <el-table
          ...
          <el-table-column label="操作"  width="260" align="center">
            <template scope="scope">
              ...
              <el-button v-if="scope.row.weekSetState=='NO_RELEASE'" size="small" @click="cancelIssued(scope.$index)" type="danger">取消下发</el-button>
          ...
          >
            <template scope="scope">
              {{scope.row.weekSetState=='NO_SUBMIT'?`未上报`:``}}
              {{scope.row.weekSetState=='NO_ISSUED'?`已上报未下发`:``}}
              {{scope.row.weekSetState=='NO_RELEASE'?`已下发未发布`:``}}
    ...
    <Modal
      ...
      <operate v-if="publishModal" :type="'publish'" :operate-data="publishData" @operate="subCallback" @cancel="cancel" :operaility-data="operailityData"></operate>
      <div slot="footer"></div>
    </Modal>
    <!--取消发布周历-->
    <Modal
      ...
      <operate v-if="unpublishModal" :type="'unpublish'" :operate-data="unpublishData" @operate="subCallback" @cancel="cancel" :operaility-data="operailityData"></operate>
      <div slot="footer"></div>
    </Modal>
    <!--下发周历-->
    <Modal
      ...
      <operate v-if="modifyStateIssuedModal" :type="'modifyStateIssued'" :operate-data="modifyStateIssuedData" @operate="subCallback" @cancel="cancel" :operaility-data="operailityData"></operate>
      <div slot="footer"></div>
    </Modal>
    <!--取消下发周历-->
    <Modal
      ...
      <operate v-if="cancelIssuedModal" :type="'cancelIssued'" :operate-data="cancelIssuedData" @operate="subCallback" @cancel="cancel" :operaility-data="operailityData"></operate>
      <div slot="footer"></div>
    </Modal>
