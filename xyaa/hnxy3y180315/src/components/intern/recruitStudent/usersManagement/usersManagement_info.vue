...
<template>
  <div :class="{'userInfoAllShow': !showTab }">
    ...
    <basic class="userInfoItem" :dataId="operailityData.id" v-show="!showTab || activeName==='basic'" ref="basic" @save="saveCall" :addRules="basicAddRules" :mustUploadHP="mustUploadHP" :formWhere="formWhere"></basic>
    ...
    <div align="center">
      ...
      <template v-if="userInfo">
        <template v-if="userInfo.auditStatus!='NOT_AUDIT'">
          <load-btn @listenSubEvent="listenSubEvent" :btnData="loadBtn"></load-btn>
          <load-btn @listenSbEvent="listenSbEvent" v-if="userInfo.auditStatus!='AUDIT_SUCCESS'" :btnData="sbBtn"></load-btn>
        </template>
        <span v-if="userInfo.auditStatus=='NOT_AUDIT'" style="margin-right: 10px;color: #FF4949;">您的档案信息正在审核中……</span>
      </template>
