...
<template>
    <div>
        ...
        <div v-if="active==2" style="margin: 20px;">
            ...
            <three-step :school-data="saveSchoolData" :initData="threeGroupData" @setGroupData="setThreeGroupData"
        ...
        <el-row :gutter="10">
            <el-col :span="24" style="text-align: center;">
                ...
                <load-btn v-if="active>2" style="margin-top: 12px;" v-show="fourGroupData.length>0&&!jumpThirdStep"
