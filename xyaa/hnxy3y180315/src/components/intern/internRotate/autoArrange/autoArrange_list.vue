  ...
  <div id="content" ref="content" class="modal">
    ...
    <div>
      ...
      >
        ...
        <autoArrangeByDepList v-if="showView=='科室'" :params="changeTabViewParams"></autoArrangeByDepList>
        <autoArrangeByUserList v-if="showView=='人员'" :params="changeTabViewParams"></autoArrangeByUserList>
      </div>
      <!--分页-->
