  ...
  <div class="editForm">
    <el-form :model="formValidate" ref="formValidate" label-width="124px"
      ...
      <el-row>
        ...
        <el-col :span="8" :offset="2">
          <el-form-item label="报废人：" prop="discarder" required>
            <el-input v-model="formValidate.discarder"></el-input>
          </el-form-item>
        </el-col>

        <el-col :span="8" :offset="2" name="start">
          <el-form-item label="报废时间：" prop="scrapTime" required>
            <el-date-picker v-model="formValidate.scrapTime" :editable="false"
        ...
        <el-col :span="18" :offset="2">
          <el-form-item label="报废说明：" prop="scrapRemarks">
            <el-input type="textarea" :autosize="{ minRows: 4, maxRows: 8}"
                      placeholder=""
                      v-model="formValidate.scrapRemarks"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
  ...
  export default {
    ...
    methods: {
      ...
      listenSubEvent (isLoadingFun) {
        ...
        this.formValidate.scrapTime = this.conductDate(this.formValidate.scrapTime, 'yyyy-MM-dd')
        if (isSubmit) {
