  ...
  <div class="editForm">
    <el-form :model="formValidate" ref="formValidate" label-width="124px"
      ...
      <el-row>
        ...
        <date-group
          :dateGroup="{text:'',startDate:formValidate.startTime,endDate:formValidate.endTime}">
          ...
          <el-col :span="8" :offset="2" name="end">
            <el-form-item label="维修结束时间：" prop="endTime">
              <el-date-picker v-model="formValidate.endTime" :editable="false"
                              type="datetime" placeholder="选择日期"
    ...
    methods: {
      ...
      listenSubEvent (isLoadingFun) {
        ...
        if (isSubmit) {
          ...
          data.startTime = this.conductDate(data.startTime,
            'yyyy-MM-dd HH:mm:ss')
