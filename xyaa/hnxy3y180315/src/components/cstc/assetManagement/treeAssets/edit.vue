<template>
  ...
  <div>
    <el-form v-if="show" ref="formValidate" :model="formValidate" :rules="rules"
      ...
      <el-row>
        ...
        <el-col :span="10" :offset="2">
          <el-form-item label="是否默认节点：" prop="isDefault">
            <el-radio-group v-model="formValidate.isDefault">
    ...
    data () {
      ...
      return {
        ...
        formValidate: {
          ...
          treeRoad: this.operailityData.treeRoad,
          remark: '',
          isDefault: 'NO',
        },
        ...
        editMessTitle: {
          ...
          ajaxError: 'ajaxError',
          ajaxParams: {
            url: this.operailityData['getTreeUrl'] + '/tree/modify/' +
...
//        }
    ...
    methods: {
      ...
      init () {
        ...
        console.log(this.operailityData, this.formValidate,9999 )
      },
      /*
       * 点击提交按钮 监听是否提交数据
