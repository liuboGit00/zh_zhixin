  ...
  <div class="editForm">
    <el-form :model="formValidate" ref="formValidate" label-width="124px"
      ...
      <el-row>
        ...
        <el-col :span="8" :offset="2">
          <el-form-item label="报损人：" prop="breakageUser" required>
            <el-input v-model="formValidate.breakageUser"></el-input>
          </el-form-item>
        </el-col>

        <el-col :span="8" :offset="2" name="start">
          <el-form-item label="报损时间：" prop="breakageTime" required>
            <el-date-picker v-model="formValidate.breakageTime" :editable="false"
        ...
        <el-col :span="18" :offset="2">
          <el-form-item label="报损说明：" prop="breakaegRemarks">
            <el-input type="textarea" :autosize="{ minRows: 4, maxRows: 8}"
                      placeholder="请输入维修设备的备注"
                      v-model="formValidate.breakaegRemarks"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
    ...
    methods: {
      ...
      listenSubEvent (isLoadingFun) {
        ...
        if (isSubmit) {
          ...
          isLoadingFun(true)
          let data
          if (this.getUrlParams && this.deptObj) { //傳入了數據
            ...
            this.editMessTitle.ajaxParams.url = this.editMessTitle.ajaxParams.url +
              '/' + this.deptObj.assetsBreakageId
            data = this.editMessTitle.ajaxParams.data
          } else {
          ...
          if (this.getUrlParams && this.deptObj) {
