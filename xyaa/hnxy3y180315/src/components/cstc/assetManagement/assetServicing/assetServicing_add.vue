      ...
      <el-row>
        ...
        <el-col :span="8" :offset="2">
          <el-form-item label="维修人：" prop="repairer" required>
            <el-input v-model="formValidate.repairer"></el-input>
          </el-form-item>
        </el-col>

        <el-col :span="8" :offset="2" name="start">
          <el-form-item label="维修开始时间：" prop="startTime" required>
            <el-date-picker v-model="formValidate.startTime" :editable="false"
        ...
        <el-col :span="18" :offset="2">
          <el-form-item label="维修说明：" prop="remarks">
            <el-input type="textarea" :autosize="{ minRows: 4, maxRows: 8}"
                      placeholder="请输入维修设备的备注"
                      v-model="formValidate.remarks"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
        ...
        if (isSubmit) {
          ...
          if (this.getUrlParams && this.deptObj) { //傳入了數據
            ...
            this.editMessTitle.ajaxParams.url = this.editMessTitle.ajaxParams.url +
              '/' + this.deptObj.assetsRepairingId
