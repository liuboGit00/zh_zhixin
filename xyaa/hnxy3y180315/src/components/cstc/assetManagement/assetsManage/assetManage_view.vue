    ...
    <el-row class="editForm">
      <el-form :model="formValidate" ref="formValidate" :rules="rules"
        ...
        <el-col :span="12" :offset="2">
          <el-form-item label="资产名称：" prop="deviceTypeName">
            {{ formValidate.assetName }}
          </el-form-item>
        </el-col>
        <el-col :span="12" :offset="2">
          <el-form-item label="资产编号：" prop="deviceTypeName">
            {{ formValidate.assetNumber }}
          </el-form-item>
        </el-col>
        <!--<el-col :span="20" :offset="2">-->
          <!--<el-form-item label="设备图片：">-->
            <!--<upload-photo-wall v-if="fileList && fileList.length" type="picture"-->
                               <!--:actionUrl="'/file/upload/static'"-->
                               <!--:fileList="fileList"-->
                               <!--:show="true"></upload-photo-wall>-->
            <!--<span v-else>暂无图片</span>-->
          <!--</el-form-item>-->
        <!--</el-col>-->
        <el-col :span="20" :offset="2">
          <el-form-item label="多媒体文件:" class="feildFontweight">
            <upload-file v-if="videoList && videoList.length"
                         :accept="'mp4,flv,rmvb,rm,avi'" :noFirstCallBack="true"
                         :uploadUrl="url.multimedia.path" :size="500*1024"
                         :uploadFiles="videoList"
                         @setUploadFiles="setMultimediaFileIds"
                         downServer="/server/" :show="true"></upload-file>
        ...
        <el-col :span="20" :offset="2">
          <el-form-item label="附件:" class="feildFontweight">
            <upload-file
              v-if="formValidate.fileList && formValidate.fileList.length"
              :size="500*1024" :uploadFiles="formValidate.fileList||[]"
...
//          this.fileList = []
//          for (var i = 0, item; i < this.formValidate.assetBaseImageList.length; i++) {
...
//          }
//        }
        res.data.videoList = res.data.assetBaseVideoList|| []
