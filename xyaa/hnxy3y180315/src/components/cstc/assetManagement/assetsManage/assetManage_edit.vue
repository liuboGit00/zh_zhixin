      ...
      <el-form :model="formValidate" ref="formValidate" :rules="rules"
        ...
        <el-col :span="12" :offset="2">
          <el-form-item label="资产名称：" prop="assetName" required>
            <el-input v-model="formValidate.assetName"
                      placeholder="请输入"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12" :offset="2">
          <el-form-item label="资产编号：" prop="assetNumber" required>
            <el-input v-model="formValidate.assetNumber"
                      placeholder="请输入"></el-input>
          </el-form-item>
        </el-col>
        <!--<el-col :span="20" :offset="2">-->
          <!--<el-form-item label="资产图片：">-->
            <!--<upload-photo-wall type="picture" :actionUrl="'/file/upload/static'"        :fileList="fileList"-->
                               <!--@upladSuccess="upladSuccess"></upload-photo-wall>-->
          <!--</el-form-item>-->
        <!--</el-col>-->
        <el-col :span="20" :offset="2">
          <el-form-item type="附件" label="多媒体文件:" class="feildFontweight">
            <upload-file :accept="'mp4,flv,rmvb,rm,avi'" :noFirstCallBack="true"
                         :uploadUrl="url.multimedia.path" :size="500*1024"
        ...
        <el-col :span="20" :offset="2">
          <el-form-item label="附件:" class="feildFontweight">
            <upload-file :uploadFiles="formValidate.fileList"
        ...
        <el-col :span="20" :offset="2">
          <el-form-item label="设备描述：" prop="describes">
            <el-input type="textarea" :autosize="{ minRows: 4, maxRows: 8}"
                      placeholder="请输入设备名称"
                      v-model="formValidate.describes"></el-input>
          </el-form-item>
        </el-col>
      </el-form>
    </el-row>
    ...
    methods: {
      ...
      listenSubEvent (isLoadingFun) {
        ...
        if (isSubmit) {
          ...
          isLoadingFun(true)
          this.editMessTitle.ajaxParams.data = this.getFormData(
            this.formValidate)
...
//        this.formValidate.assetBaseImageList = []
//        for (var i = 0; i < fileList.length; i++) {
//          let file = (fileList[i].src || '').match(/(static.*)(\..*)/)
//          this.formValidate.assetBaseImageList.push({
//            originalPath: file[0],
...
//        if (typeof this.formValidate.assetBaseImageList != 'undefined') {
//          this.fileList = []
//          for (var i = 0, item; i <
//          this.formValidate.assetBaseImageList.length; i++) {
//            item = this.formValidate.assetBaseImageList[i]
//            let obj = {
//              name: '',
...
//          }
//        }
        res.data.assetBaseVideoList = res.data.assetBaseVideoList || []
        for (let i = 0; i < res.data.assetBaseVideoList.length; i++) {
          let item = res.data.assetBaseVideoList [i]
          item.fileId = item.path
        }
        this.videoList = res.data.assetBaseVideoList
      },
      /*
       * 组件初始化入口
       * */
      ...
      setMultimediaFileIds (ids, lists) {
        ...
        this.formValidate.assetBaseVideoList = multimediaFileList
      },
