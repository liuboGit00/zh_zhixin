<template>
  <div>
    <layout-tree style="height:500px;">
      <!-- 左侧目录树 -->
      <tree-menu slot="left" @tree-click="treeClick"
          ...
          <el-table align="center" :height="dynamicHt" :context="self"
            ...
            <el-table-column type="expand">
              <template scope="props">
                <template
                  v-if="props.row.deviceList && props.row.deviceList.length > 0">
                  <!-- 更多数据 -->
                  <div class="tableMoreInfo">
                    <div class="tableMoreInfoTitle"
                         v-for="item in props.row.deviceList" :key="item.id">
            ...
            <el-table-column label="名称" prop="deviceTypeName"
