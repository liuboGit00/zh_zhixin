          ...
          <el-row>
              ...
              <el-form :inline="true" :model="item" label-width="84px">
                ...
                <el-col :span="8">
                  <el-form-item label="设备型号：">
                    <el-input v-model="item.model" placeholder="请输入"
                              size="small"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="生产日期：">
                    <el-date-picker v-model="item.manufactureDate" type="date"
                                    placeholder="选择日期"
                                    size="small">
                    </el-date-picker>
                  </el-form-item>
                ...
                <el-col :span="8">
                  <el-form-item label="保修截止：">
                    <el-date-picker v-model="item.guaranteeDate" type="date"
                                    placeholder="选择日期"
                                    size="small">
                    </el-date-picker>
                  </el-form-item>
                ...
                <el-col :span="8">
                  <el-form-item label="单价：">
                    <el-input v-model="item.price" @blur="formatRMB(item)"
                              size="small"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item label="使用次数：">
                    <el-input v-model="item.useTime" placeholder="使用次数"
                              size="small"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                ...
                <el-col :span="8">
                  <el-form-item label="存放地点：">
                    <el-input size="small" v-model="item.storageLocation"
                              placeholder="请选择或者输入"
                              @input="inputStorageLocation(item)">
                      <el-button slot="append" @click.stop="selectRoom(item)"
                                 size="mini"
                                 icon="plus"></el-button>
                    </el-input>
                ...
                <el-col :span="8">
                  <el-form-item label="设备描述：" class="describeBox">
                    <el-input type="textarea"
                              ...
                              placeholder="设备描述"
                              v-model="item.describes"></el-input>
                  </el-form-item>
                </el-col>
              </el-form>
            </el-col>
            <el-col :span="6" align="center">
              ...
              <el-col :span="6">
                <div>
                  <p>
                    <el-button type="success" size="small" @click="save(item)">
                      保存
                    </el-button>
                  </p>
                  <p>
                    <!--<el-button type="warning" size="small" @click="edit(item.id)">修改</el-button>-->
                    <el-button type="warning" size="small" @click="edit(item)">
                      修改
                    </el-button>
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    <el-button type="info" size="small" @click="show(item)">详情
                    </el-button>
                  </p>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 保存
      save (obj) {
        obj = this.formDate(obj, ['manufactureDate', 'guaranteeDate'],
          this.yearMonthData)
        this.ajax({
          type: 'edit',
          successTitle: '保存成功!',
