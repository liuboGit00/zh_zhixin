<template>
  <el-row class="deviceMoreInfoShow">
    <div class="qrImgs">
      <img :src="'/api/file/download/'+formValidate.qrcode"
    ...
    <el-form :model="formValidate" ref="formValidate" label-width="124px">
      ...
      <el-col :span="9" :offset="2">
        <el-form-item label="报废期限：" prop="discardingTimeLimit">
          {{formValidate.discardingTimeLimit}}
        </el-form-item>
      </el-col>
      <el-col :span="9" :offset="2">
        <el-form-item label="折旧方式：" prop="depreciationMethod">
          ...
          <!--</el-option>-->
          <!--</el-select>-->
          {{formValidate.depreciationMethod|assetZJFS}}
        </el-form-item>
      </el-col>
      <el-col :span="9" :offset="2">
        <el-form-item label="经费来源：" prop="fundsSource">
          {{formValidate.fundsSource|assetJFLY}}
      ...
      <el-col :span="9" :offset="2">
        <el-form-item label="使用方向：" prop="directionUse">
          {{formValidate.directionUse|assetSYFX}}
      ...
      <el-col :span="9" :offset="2">
        <el-form-item label="设备来源：" prop="purchaseSource">
          {{formValidate.purchaseSource|assetSBLY}}
      ...
      <el-col :span="9" :offset="2">
        <el-form-item label="入库时间：" prop="warehousingTime"
          ...
          <!--</el-input>-->
         {{formValidate.warehousingTime}}
        </el-form-item>
      </el-col>
      <el-col :span="9" :offset="2">
        <el-form-item label="发票号：" prop="invoiceNumber">
          {{formValidate.invoiceNumber}}
        </el-form-item>
      </el-col>
      <el-col :span="20" :offset="2">
        <el-form-item label="资产图片：">
          <upload-photo-wall type="picture" :actionUrl="'/file/upload/static'" :fileList="fileListOfCopy"  :show="true"></upload-photo-wall>
        </el-form-item>
      </el-col>
      <el-col :span="20" :offset="2">
        <el-form-item label="发票图片：">
          <upload-photo-wall type="picture" :show="true"
                             ...
                             :fileList="fileList"></upload-photo-wall>
        </el-form-item>
      </el-col>
      <el-col :span="20" :offset="2">
      ...
      <el-col :span="20" :offset="2">
        <el-form-item label="备注：" prop="operator">
          {{ formValidate.remark}}
        </el-form-item>
...
//            }
    ...
    components: {
      myVideo, viewPPT, uploadPhotoWall,
    },
  }
