      ...
      <el-form :model="formValidate" ref="formValidate" :rules="rules"
        ...
        <el-col :span="9" :offset="2">
          <el-form-item label="购买时间：" prop="purchaseTime" required>
            <el-date-picker v-model="formValidate.purchaseTime"
        ...
        <el-col :span="9" :offset="2">
          <el-form-item label="使用次数：" prop="useTime" required>
            <el-input v-model="formValidate.useTime"
        ...
        <el-col :span="9" :offset="2">
          <el-form-item label="维修电话：" prop="servicingPhone">
            <el-input v-model="formValidate.servicingPhone"
                      placeholder="请输入维修电话"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="9" :offset="2">
          <el-form-item label="厂商电话：" prop="manufacturerPhone">
            <el-input v-model="formValidate.manufacturerPhone"
                      placeholder="请输入厂商电话"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="9" :offset="2">
          <el-form-item label="购买地址：" prop="buyAdderss">
            <el-input v-model="formValidate.buyAdderss"
                      placeholder="请输入购买地址"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="9" :offset="2">
          <el-form-item label="存放地点：" prop="storageLocation"
            ...
            <el-input v-model="formValidate.storageLocation"
                      placeholder="请选择或者输入" @input="inputStorageLocation">
        ...
        <el-col :span="9" :offset="2">
          <el-form-item label="设备编号：" prop="deviceIdentifier" required>
            <el-input v-model="formValidate.deviceIdentifier"
        ...
        <el-col :span="9" :offset="2">
          <el-form-item label="生产日期：" prop="manufactureDate" required>
            <el-date-picker v-model="formValidate.manufactureDate"
                            :editable="false" type="date" placeholder="选择生产日期">
            </el-date-picker>
          </el-form-item>
        </el-col>
        <el-col :span="9" :offset="2">
        ...
        <el-col :span="20" :offset="2">
          <el-form-item label="设备描述：" prop="describes">
            <el-input type="textarea" :autosize="{ minRows: 2, maxRows: 4}"
                      placeholder="请输入内容" v-model="formValidate.describes">
            </el-input>
          </el-form-item>
        </el-col>
      </el-form>
    ...
    methods: {
      ...
      listenSubEvent (isLoadingFun) {
        ...
        if (isSubmit) {
          ...
          data.purchaseTime = this.conductDate(data.purchaseTime,
            'yyyy-MM-dd hh:mm:ss')
