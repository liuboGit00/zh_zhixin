  ...
  <div id="nosocomial" ref="nosocomial">
    <el-row>
      <el-col :xs="24" :md="14">
        ...
        <div class="buttonList">
          ...
          <el-button size="small" type="info" @click="excelExport">导出
          </el-button>
    ...
    <div id="deviceTable" ref="deviceTable">
      <el-table align="center" :height="dynamicHt" :context="self"
        ...
        <el-table-column label="设备名称" prop="deviceTypeName"
                         show-overflow-tooltip width="100"></el-table-column>
        <el-table-column label="设备编号" prop="deviceIdentifier"
                         show-overflow-tooltip width="100"></el-table-column>
        <el-table-column label="规格" prop="specifications" show-overflow-tooltip
        ...
        <el-table-column label="使用方向" prop="directionUse" show-overflow-tooltip
                         width="100"></el-table-column>
        <el-table-column label="使用部门" prop="useDepartment" show-overflow-tooltip
                         width="100"></el-table-column>
        <el-table-column label="责任人" prop="personLiable" show-overflow-tooltip
                         width="100"></el-table-column>
        ...
        <el-table-column label="出厂编号" prop="factoryNumber" show-overflow-tooltip
                         width="100"></el-table-column>
        <el-table-column label="出厂日期" prop="manufactureDate"
                         show-overflow-tooltip width="100"></el-table-column>
        <el-table-column label="发票号" prop="invoiceNumber" show-overflow-tooltip
                         width="100"></el-table-column>
        <el-table-column label="购置来源" prop="purchaseSource"
                         show-overflow-tooltip width="100"></el-table-column>
        <el-table-column label="折旧方式" prop="depreciationMethod"
                         show-overflow-tooltip width="100"></el-table-column>
        <el-table-column label="备注" prop="describe" show-overflow-tooltip
                         width="100"></el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      SelectionChangeDevice (val) {
        let ids = []
        let oldMultipleSelection = Util._.defaultsDeep([],
          this.multipleSelection)
        this.todoId = (val[0] && val[0].depId) || '';
        (oldMultipleSelection || []).map(
          item => this.tableAllIds[item.id].selAll = false)
        // 同时选中子选项
        val.map(item => {
...
//        }
      ...
      excelExport () {
        if (this.isSelected()) {
          ...
          this.derUrl = '/api/device/excelExport' + '?depId=' + this.depId +
