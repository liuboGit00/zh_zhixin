...
<template>
  <div ref="roomUse" style="height: 100%">
    <el-form :inline="true" :model="searchObj" ref="searchForm" label-width="66px" class="el-form-item-search" style="margin-top:10px">
    ...
    <div id="myTable" ref="myTable" class="statisticsBox">
