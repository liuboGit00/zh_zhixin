      ...
      <el-form :model="formValidate" ref="formValidate" :rules="rules" label-width="124px">
        ...
        <el-col :span="9" :offset="2">
          <el-form-item label="父资产编号：" prop="parentAssetsNumber">
            <el-input v-model="formValidate.parentAssetsNumber" placeholder="请输入"></el-input>
          </el-form-item>
        </el-col>
        </el-col>
        <el-col :span="9" :offset="2">
          <el-form-item label="资产名称：" prop="assetName">
            <el-select v-model="formValidate.baseId" placeholder="请选择" @change="selectAssetBase">
              <el-option v-for="item in assetNameList" :key="item.baseId" :label="item.assetName" :value="item.baseId">
              </el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="9" :offset="2">
          <el-form-item label="资产编号：" prop="assetNumber">
            <el-input v-model="formValidate.assetNumber" placeholder="请输入"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="9" :offset="2">
          <el-form-item label="资产分类：" prop="treeId">
            <el-select v-model="formValidate.treeId" placeholder="请选择" @change="selectTreeId">
              <el-option v-for="item in assetBaseList" :key="item.treeId" :label="item.treeName" :value="item.treeId">
              </el-option>
            </el-select>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="9" :offset="2">
          <el-form-item label="规格：" prop="standard">
            <el-input v-model="formValidate.standard" placeholder="请输入设备规格"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="9" :offset="2">
        ...
        <el-col :span="9" :offset="2">
          <el-form-item label="厂家：" prop="manufacturer">
            <el-input v-model="formValidate.manufacturer" placeholder="请输入供应商"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="9" :offset="2">
        ...
        <el-col :span="9" :offset="2">
          <el-form-item label="购置日期：" prop="purchaseDate">
            <el-date-picker v-model="formValidate.purchaseDate" :editable="false" type="date" placeholder="选择日期" required></el-date-picker>
          </el-form-item>
        </el-col>
        <el-col :span="9" :offset="2">
          <el-form-item label="保修截至时间：" prop="guaranteeDate">
            <el-date-picker v-model="formValidate.guaranteeDate" :editable="false" type="date" placeholder="选择日期"></el-date-picker>
          </el-form-item>
        </el-col>
        <el-col :span="9" :offset="2">
          <el-form-item label="报废期限：" prop="discardingTimeLimit">
            <el-input style="width: 80%" v-model="formValidate.discardingTimeLimit" placeholder="请输入"></el-input>年
          </el-form-item>
        </el-col>
        <el-col :span="9" :offset="2">
          <el-form-item label="折旧方式：" prop="depreciationMethod">
            <el-select v-model="formValidate.depreciationMethod" placeholder="请选择">
              <el-option v-for="item in ZJFS" :key="item.code" :label="item.name" :value="item.code">
              </el-option>
            </el-select>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="9" :offset="2">
          <el-form-item label="使用方向：" prop="directionUse">
            <el-select v-model="formValidate.directionUse" placeholder="请选择">
              <el-option v-for="item in SYFX" :key="item.code" :label="item.name" :value="item.code">
              </el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="9" :offset="2">
          <el-form-item label="设备来源：" prop="purchaseSource">
            <el-select v-model="formValidate.purchaseSource" placeholder="请选择">
              <el-option v-for="item in SBLY" :key="item.code" :label="item.name" :value="item.code">
              </el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="9" :offset="2">
          <el-form-item label="经手人" prop="operator">
            <el-input v-model="formValidate.operator" placeholder="请输入"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="9" :offset="2">
          <el-form-item label="记账人" prop="bookkeeper">
            <el-input v-model="formValidate.bookkeeper" placeholder="请输入"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="9" :offset="2">
          <el-form-item label="合同编号" prop="contractId">
          <el-select v-model="formValidate.contractId" placeholder="请选择" @change="selectContactId">
            <el-option v-for="item in contractList" :key="item.contractId" :label="item.contractNumber" :value="item.contractId">
            </el-option>
          </el-select>
         <!---->
        ...
        <el-col :span="20" :offset="2">
          <el-form-item label="合同复印件：">
            <upload-photo-wall type="picture" :actionUrl="'/file/upload/static'" :fileList="fileListOfCopy" @upladSuccess="upladSuccessOfCopy"></upload-photo-wall>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="20" :offset="2">
          <el-form-item label="备注：" prop="remark">
            <el-input type="textarea" :autosize="{ minRows: 2, maxRows: 4}" placeholder="请输入内容" v-model="formValidate.remark">
            </el-input>
          </el-form-item>
        </el-col>
      </el-form>
...
//          JFLYList:[],
      ...
      * */
      ...
      getEditDataSuccess (res) {
        ...
        if (res.data.assetsContractImage && res.data.assetsContractImage.length) {
