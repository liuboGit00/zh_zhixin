      ...
      <el-form :inline="true">
        ...
        <el-form-item label="刷卡时间:">
          <date-group :dateGroup="{text:'',startDate:searchObj.swingStartTime,endDate:searchObj.swingEndTime}">
            <el-date-picker name="start" v-model="searchObj.swingStartTime" :editable="false" type="datetime" placeholder="选择开始时间" :picker-options="pickerOptions0"
              @change="handleStartTime"></el-date-picker>
            <span>-</span>
            <el-date-picker name="end" v-model="searchObj.swingEndTime" :editable="false" type="datetime" placeholder="选择结束时间" :picker-options="pickerOptions1"
