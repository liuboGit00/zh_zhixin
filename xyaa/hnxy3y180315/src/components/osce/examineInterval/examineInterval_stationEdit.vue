<template>
  ...
  <div id="stationMain" ref="stationMain" style="height:100%;">
    <div class="el-form selectUserBox">
      <fieldset style="max-height:200px;" v-if="this.info.isTeacherContent!='NO'">
  ...
  export default {
    ...
    methods: {
      ...
      initGetStation (res) {
        ...
        console.log('scriptList', spList, scriptList);
        // 更新SP人员的可选择剧本
      ...
      listenSubEvent (isLoadingFun) {
        ...
        this.modifyMessTitle.ajaxParams.data.stationList&&this.modifyMessTitle.ajaxParams.data.stationList.map((item)=>{
          item.roomSpecialtyList&&item.roomSpecialtyList.map((item1)=>{item1.specialty=item1.specialty.toString()})
        })
        console.log(6666,this.modifyMessTitle.ajaxParams.data)
