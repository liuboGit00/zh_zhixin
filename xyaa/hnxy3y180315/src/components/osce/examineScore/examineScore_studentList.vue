<template>
  ...
  <div style="height:100%;">
      ...
      <div class="examineScoreInfoVideo">
        <div class="teacherInfo">
          ...
          <div class="teacherInfoBox">
            ...
            <p class="teacherInfoText">分站时间：{{ (stationTeacher.timeLength/60) || '0'}}分钟</p>
    ...
    <Modal :mask-closable="false" v-model="studentInfoModal" height="200" title="对话框标题" class-name="vertical-center-modal" :loading="true"
      ...
      <student-info :sceneType="sceneType" v-if="studentInfoModal" @cancel="cancel" :stationId="stationId" :roomId="roomId" :sceneId="sceneId" :userSum="userSum"
