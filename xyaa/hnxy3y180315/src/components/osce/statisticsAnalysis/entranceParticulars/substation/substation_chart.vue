...
<template>
  <div class="substationChart">
    ...
    <div :style="{'height':contenHeight + 'px'}" class="substationChartItem substationChartItemTop" id="pieBox"></div>
  ...
  export default {
    ...
    methods: {
      ...
      getPieOption (data) {
        ...
        console.log(opt,999)
        if(opt.series[1].data.length>50){
         this.contenHeight+=(opt.series[1].data.length-50)*10
        }
        return opt;
      },
      getLineOption (data) {
