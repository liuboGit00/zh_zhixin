    ...
    <div class="monitoStationInfo">
      ...
      <el-collapse-transition>
        <p class="noMarginBottom">
          <el-button  v-show="monitorData.status === 'PUBLISH'" type="success" @click="modifyStatus('READY')">考核准备</el-button>
          <el-button v-show="monitorData.status === 'READY'" type="success" @click="modifyStatus('ONGOING')">开始考核</el-button>
        </p>
      </el-collapse-transition>
      <el-collapse-transition>
