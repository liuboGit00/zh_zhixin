...
<template>
  <div >
    ...
    <Modal
      ...
      <to-channel v-if="toChannelModal" :id="id" :commitBefFun="commitBefFun" :treeRoad="treeRoad" @cancel="closeChannel"  :url="url.save.path"  @success="subHandelEvent" :data="convertedData" :format="format"></to-channel>
      <div slot="footer"></div>
    </Modal>
  </div>
</template>
